            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="edit-subscription" method="post" action="<?php echo e(route('update-subscription', $subscription_detail->id)); ?>">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" id="name" value="<?php echo e($subscription_detail->name); ?>">
...
unset($__errorArgs, $__bag); ?>" name="android_sku_code" id="android_sku_code" value="<?php echo e($subscription_detail->android_sku_code); ?>">
...
unset($__errorArgs, $__bag); ?>" name="ios_sku_code" id="ios_sku_code" value="<?php echo e($subscription_detail->ios_sku_code); ?>">
...
unset($__errorArgs, $__bag); ?>"  style="height: 100px"> <?php echo e($subscription_detail->description); ?></textarea>       
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/subscription/view.blade.php ENDPATH**/ ?>