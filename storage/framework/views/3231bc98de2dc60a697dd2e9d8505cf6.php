...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.booking.list')); ?>">Reservations</a></li>
...
<div class="container-fluid">
    <form method="POST" action="<?php echo e(route('admin.booking.edit', $booking->id)); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-md-3">
                <div class="form-section">
                    ...
                    <div class="form-section-body">
                        <div class="mb-3">
                            <span class="status-badge status-<?php echo e(strtolower($booking->status ?? 'confirmed')); ?>">
                        ...
                        <div class="reservation-timeline">
                            <div class="timeline-item">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted"><?php echo e($booking->created_at ? $booking->created_at->format('d-m-Y H:i') : '21-05-2025 10:56'); ?></small>
                                </div>
                            </div>
                            <div class="timeline-item">
                        ...
                        <div class="mt-4">
                            <div class="res-code"><?php echo e($booking->reservation_code ?? '62MYR8V'); ?></div>
                            <div class="res-id">ResID: <?php echo e($booking->id ?? '32666231'); ?> <small>(internal use only)</small></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-section-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="room_type_id" id="room_type_select">
                                        ...
                                        <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roomType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($roomType->room_type_id); ?>" 
                                                <?php echo e(($booking->room_type_id ?? '') == $roomType->room_type_id ? 'selected' : ''); ?>>
                                                <?php echo e($roomType->room_name); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="checkin_date" value="<?php echo e($booking->checkin_date ?? '2025-06-10'); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="room_id" id="room_name_select">
                                        ...
                                        <?php if(isset($booking->room_type_id)): ?>
                                            <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($room->room_type_id == $booking->room_type_id): ?>
                                                    <option value="<?php echo e($room->room_id); ?>" 
                                                        <?php echo e(($booking->room_id ?? '') == $room->room_id ? 'selected' : ''); ?>>
                                                        <?php echo e($room->room_id); ?> - <?php echo e($room->room_name); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="checkout_date" value="<?php echo e($booking->checkout_date ?? '2025-06-12'); ?>">
                                    <div class="time-format-note">use 24 hour format</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Source:</label>
                                    <input type="text" class="form-control" name="booking_source" value="<?php echo e($booking->booking_source ?? 'SabeeApp Connect API'); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nr. of nights:</label>
                                    <input type="number" class="form-control" name="nights" value="<?php echo e($booking->nights ?? '2'); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="reservation_date" value="<?php echo e($booking->created_at ? $booking->created_at->format('d-m-Y H:i') : '21-05-2025 10:56'); ?>" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="Confirmed" <?php echo e(($booking->status ?? 'Confirmed') === 'Confirmed' ? 'selected' : ''); ?>>Confirmed</option>
    ...
    $(document).ready(function() {
        ...
        $('#room_type_select').change(function() {
            ...
            if (roomTypeId) {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.booking.get-rooms")); ?>',
                    type: 'GET',
                    data: {
        ...
        $('select[name="status"]').change(function() {
            ...
            if (newStatus === 'Cancelled' || newStatus === 'NoShow') {
                if (!confirm('Are you sure you want to change the status to ' + newStatus + '?')) {
                    $(this).val('<?php echo e($booking->status ?? "Confirmed"); ?>');
                }
            }
        });
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/booking/edit.blade.php ENDPATH**/ ?>