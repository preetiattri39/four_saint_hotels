      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="Edit-Staff" action="<?php echo e(route('admin.staff.edit',['id' => $user->id])); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
                <fieldset>
...
unset($__errorArgs, $__bag); ?>" >
                                    ...
                                    <option value="Other" <?php echo e($user->userDetail ? (($user->userDetail->gender == 'Female' ) ? 'selected': '') : ''); ?>>Other</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" >
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->id); ?>" <?php echo e($role->id == $user->role_id ? 'selected' : ''); ?>><?php echo e(ucfirst($role->name)); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="phone" placeholder="Phone Number" name="phone_number" value="<?php echo e($user->userDetail ? ($user->userDetail->phone_number ?? '') : ''); ?>" pattern="\d*" inputmode="numeric" 
...
unset($__errorArgs, $__bag); ?>" id="dob" placeholder="dob" name="dob"  value="<?php echo e($user->userDetail ? ($user->userDetail->dob ?? '') : ''); ?>">
                                <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/staff/edit.blade.php ENDPATH**/ ?>