...
<div class="content-wrapper user-manage-box">
    <div class="top-titlebar d-flex justify-content-between align-items-center pb-2">
        ...
        <div class="add-icon d-flex gap-3">
            <a href="<?php echo e(route('add-faq')); ?>" class="d-flex align-items-center">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#faq-table').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('faq-data')); ?>',  // Fetch data from the server
                data: function(d) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    searchable: false,
                    render: function(data, type, row) {
                         let ticketDetailsUrl = '<?php echo e(route('faq-details', ['faq_id' => '__faq_id__'])); ?>'.replace('__faq_id__', row.id);
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '<?php echo e(route("delete-faq", ["faq_id" => "__faq_id__"])); ?>'.replace("__faq_id__", subscriptionId);
            }
        });
    });
</script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/faq/index.blade.php ENDPATH**/ ?>