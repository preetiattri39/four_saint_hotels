...
<div class="container-cstm about-page">
  <section class="about-section  abot bgblue relative">
        <div class="about-banenr-cnt text-center">
            ...
            <p class="f-18 gray"><?php echo $page->content; ?></p>
        </div>
  
    <img src="<?php echo e(asset('images/plane.svg')); ?>" class="shape-plane grow" alt="shape" />
    <img src="<?php echo e(asset('images/circle.svg')); ?>" class="shape-circles left-1" alt="shape" />
  ...
  <section class="believe-section relative">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="relative beleive-box text-center">
                        <img src="<?php echo e(asset('images/future.png')); ?>" class="future-icon" />
                ...
                <div class="col-12 col-md-6">
                    <div class="relative beleive-box text-center">
                        <img src="<?php echo e(asset('images/future1.png')); ?>" class="future-icon" />
    ...
    <img src="<?php echo e(asset('images/poly.svg')); ?>" class="shape-poly" alt="shape" />
    <img src="<?php echo e(asset('images/poly1.svg')); ?>" class="shape-polygn" alt="shape" />
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/home/about-us.blade.php ENDPATH**/ ?>