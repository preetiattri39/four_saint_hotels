<?php $__env->startSection('title', 'View Faq'); ?>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="edit-subscription" method="post" action="<?php echo e(route('update-faq', $faq_detail->id)); ?>">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"  style="height: 100px"> <?php echo e($faq_detail->question); ?></textarea>       
...
unset($__errorArgs, $__bag); ?>"  style="height: 100px"> <?php echo e($faq_detail->answer); ?></textarea>       
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/faq/view.blade.php ENDPATH**/ ?>