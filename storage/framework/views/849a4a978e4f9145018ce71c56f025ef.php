...
<div class="content-wrapper user-manage-box">
    <div class="top-titlebar d-flex justify-content-between align-items-center pb-2">
        ...
        <div class="add-icon d-flex gap-3">
            <a href="<?php echo e(route('add-subscription')); ?>" class="d-flex align-items-center">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#subscription-table').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('subscription-data')); ?>',  // Fetch data from the server
                data: function(d) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    searchable: false,
                    render: function(data, type, row) {
                         let ticketDetailsUrl = '<?php echo e(route('subscription-details', ['subscription_id' => '__ticket_id__'])); ?>'.replace('__ticket_id__', row.id);
    ...
    $(document).on('change','input.status_subscription',function(){ 
        ...
        $.ajax({
            method: 'GET',
            url: '<?php echo e(route("subscription-status")); ?>',
            data: {
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '<?php echo e(route("delete-subscription", ["subscription_id" => "__subscription_id__"])); ?>'.replace("__subscription_id__", subscriptionId);
            }
        });
    });
</script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/subscription/index.blade.php ENDPATH**/ ?>