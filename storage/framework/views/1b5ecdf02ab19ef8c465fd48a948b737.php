            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-stripe">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="menu-icon">
                                        <a href="<?php echo e(route('admin.hotel.view',['id' => $hotel->hotel_id])); ?>" title="View" class="text-primary"><i class="mdi mdi-eye"></i></a>
                                    </span>&nbsp;&nbsp;&nbsp;

                                    <span class="menu-icon">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#uploadImagesModal" data-hotel-id="<?php echo e($hotel->id); ?>" data-rate-per-night ="<?php echo e($hotel->rate_per_night); ?>" data-description="<?php echo e($hotel->description); ?>" title="Add Images" class="text-success openImageUploadModal">
...
<script>
    ...
    document.getElementById('uploadImagesForm').addEventListener('submit', function (e) {
        ...
        fetch("<?php echo e(route('admin.hotel.upload.images')); ?>", {
            method: "POST",
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/hotel/list.blade.php ENDPATH**/ ?>