<head>
    ...
    <script>
        ...
        if ('<?php echo e(auth()->guard('admin')->check()); ?>') {
            // Initialize Pusher
            ...
            newUserEventChannel.bind('NewUserEvent', function(data) {
                ...
                var loggedInUserIsAdmin = <?php echo auth()->guard('admin')->user() && auth()->guard('admin')->user()->roles->first()->name === 'super-admin' ? 'true' : 'false'; ?>;
            ...
            function appendNotificationToHeader(notification) {
                ...
                if (notificationList) {
                    ...
                    if (notification.title) {
                        if (notification.title === 'New Ticket') {
                            route = "<?php echo e(route('tickets')); ?>";
                        } else {
                            route = "<?php echo e(route('user-list')); ?>";
                        }
                    }
                ...
                if (!document.querySelector('#header-notification-list #view-all-notifications-btn')) {
                    const viewAllButton = `
                        ...
                        <a href="<?php echo e(route('notification-list')); ?>" class="dropdown-item preview-item" id="view-all-notifications-btn">
...
</head><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/layouts/head.blade.php ENDPATH**/ ?>