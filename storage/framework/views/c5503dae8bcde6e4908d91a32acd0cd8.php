...
<div>
    <form action="<?php echo e(route('admin.role.add')); ?>" method="POST" id="add-role">
        <?php echo csrf_field(); ?>
                            ...
                            <div class="selection-body">
                                <div class="selection-row selection-row-heading main-heading">
                                    <div class="selection-td">
                                        <input type="checkbox" name="<?php echo e($key); ?>" id="<?php echo e($key); ?>" class="main-td" data-value="<?php echo e($key); ?>">
                                ...
                                <div class="selection-row">
                                    <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="selection-td <?php echo e($key); ?>">  
                                            <input class="permission-key" type="checkbox" name="permissions[]" id="<?php echo e($value->name); ?>"  data-value="<?php echo e($key); ?>" value="<?php echo e($value->name); ?>">
                                            <?php
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/role/add.blade.php ENDPATH**/ ?>