...
<?php endif; ?>
              ...
              <a href="<?php echo e(route('admin.announcements.create')); ?>" class="add-btn"><button type="button" class="btn btn-primary btn-md">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('announcements-index')): ?>
              <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $announcement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <tr data-id="<?php echo e($data->id); ?>">
                    <td><?php echo e(++$key); ?></td>
                    <td> <?php echo e(Str::limit($data->title,50, '...')); ?> </td>
                    <td> <?php echo e(Str::limit(strip_tags($data->message), 50, '...')); ?> </td>


                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('announcements-change-status')): ?> 
                      <td> 
                        <div class="toggle-user dark-toggle">
                        <input type="checkbox" name="status" data-id="<?php echo e($data->id); ?>" class="switch" <?php if($data->status == 1): ?> checked <?php endif; ?> data-value="<?php echo e($data->status); ?>">
                        </div> 
                    </td>
                    <?php endif; ?>
          ...
          <div class="custom_pagination">
            <?php echo e($announcement->appends(request()->query())->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/announcements/list.blade.php ENDPATH**/ ?>