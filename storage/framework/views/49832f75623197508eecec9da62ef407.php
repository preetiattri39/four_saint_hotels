...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#tickets-table').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('ticket-data')); ?>',  // Fetch data from the server
                data: function(d) {
            ...
            columns: [
                ...
                { data: 'status', name: 'status' },
                {
                    ...
                    render: function(data, type, row) {
                        let ticketDetailsUrl = '<?php echo e(route('ticket-details', ['ticket_id' => '__ticket_id__'])); ?>'.replace('__ticket_id__', row.id);
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '<?php echo e(route("delete-ticket", ["ticket_id" => "__ticket_id__"])); ?>'.replace("__ticket_id__", ticketId);
            }
        });
    });
</script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/four_saints_hotels/resources/views/admin/ticket/index.blade.php ENDPATH**/ ?>